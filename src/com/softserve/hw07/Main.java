...
public class Main {
   ...
   /* Створіть масив співробітників і додайте співробітників з іншою формою оплати.
    Розташуйте всю послідовність робітників за убуванням середньомісячної заробітної плати.
    Для всіх елементів списку виведіть ідентифікатор працівника, прізвище та середньомісячну заробітну плату.
    */
